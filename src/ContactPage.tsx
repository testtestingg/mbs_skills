// ContactPage.tsx (Updated with correct color scheme)
...
const ContactPage = memo(({ isOpen, onClose, language, translations }: ContactPageProps) => {
  ...
  const t = useCallback((key: string): string => translations[key]?.[language] || key, [translations, language]);
  ...
  return (
    ...
    >
      ...
      <div 
        ref={modalRef}
        className="relative bg-white border border-gray-200 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden flex flex-col"
        style={{ 
      ...
      >
        ...
        <button 
          onClick={onClose}
          className={`absolute top-4 z-10 p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors ${
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className={`w-full bg-white border border-gray-200 rounded-lg py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    >
                      <option value="">
        ...
        {/* Footer Note */}
        <div className="p-4 border-t border-gray-100 text-center text-gray-600 text-sm">
          {language === 'fr' ? "Nous vous répondrons dans les plus brefs délais." : 
